...
const CreatePostPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess(`Post "${createdPost.title}" successfully created! Redirecting...`);
            setLoading(false);
    ...
    return (
        <div className="max-w-4xl mx-auto py-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-lg">
                ...
                <div>
                    <label htmlFor="content" className="block text-lg font-medium text-gray-700 mb-1">Content (Rich Text Editor Placeholder)</label>
                    <TextEditor 
            ...
            />
                ...
                <div>
                    ...
                    */}
                    <div>
                        ...
                        <input type="text" value={post.featuredImage} readOnly disabled className="w-full border rounded text-sm bg-gray-100"/>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="category" id="category" value={post.category} onChange={handleChange} required className="w-full border-gray-300 rounded-lg shadow-sm">
                ...
                <fieldset className="border p-4 rounded-lg space-y-4">
                    ...
                    <div>
                        <label htmlFor="metaTitle" className="block text-sm font-medium text-gray-700 mb-1">Meta Title (FR-6.4)</label>
                        <input
                            type="text"
                            name="metaTitle"
                            id="metaTitle"
                    ...
                    <div>
                        <label htmlFor="metaDescription" className="block text-sm font-medium text-gray-700 mb-1">Meta Description (FR-6.4)</label>
                        <textarea
