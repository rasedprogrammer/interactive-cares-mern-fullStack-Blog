// blog-application/frontend/src/components/CategoryList.jsx
'use client';
...
const CategoryList = () => {
    ...
    if (error) return <p className="text-sm text-red-500">Error loading categories.</p>;
    if (categories.length === 0) return null;

    return (
        <div className="bg-white p-6 rounded-lg shadow-md space-y-4">
            <h3 className="text-xl font-bold text-gray-800 border-b pb-2">Top Categories</h3>
