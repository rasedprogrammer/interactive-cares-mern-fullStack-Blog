// blog-application/frontend/src/components/SearchBarComponent.jsx
'use client';
...
const SearchBarComponent = ({ isMobile = false }) => {
    ...
    return (
        <form onSubmit={handleSearchSubmit} className={`flex ${isMobile ? 'order-last mt-4 border-t border-gray-700 pt-4' : 'max-w-xs'}`}>
            <input
                type="search"
                value={searchKeyword}
