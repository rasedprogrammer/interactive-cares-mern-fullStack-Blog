...
const AdminDashboardPage = () => {
    ...
    if (loading || authLoading) return <div className="text-center py-20">Loading Admin Dashboard...</div>;
    if (error) return <div className="text-center py-20 text-red-600">ERROR: {error}</div>;

    return (
        <div className="py-10">
            <h1 className="text-4xl font-bold mb-8">Admin Dashboard (FR-3.5)</h1>
