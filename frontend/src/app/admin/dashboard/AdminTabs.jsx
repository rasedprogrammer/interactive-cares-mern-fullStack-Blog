// blog-application/frontend/src/app/admin/dashboard/AdminTabs.jsx
'use client';
...
const AdminTabs = ({ initialUsers }) => {
    ...
    const tabs = [
        ...
        { id: 'posts', label: 'Post Moderation (FR-3.5)' },
        { id: 'categories', label: 'Category Management (NEW)' },
        { id: 'comments', label: 'Comment Moderation (FR-4.3)' },
    ];
    ...
    return (
        <div>
            ...
            {/* Tabs Content */}
            <div className="mt-8">
                {activeTab === 'users' && <UserManagement initialUsers={initialUsers} />}
